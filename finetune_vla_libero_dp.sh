...
# srun --gres=gpu:$1 
srun --job-name=lib_$2 --cpus_per_task 32 --gres=gpu:$1 torchrun --rdzv_id=$SLURM_JOB_ID --rdzv_backend=static --master_port=$RDZV_PORT --nnodes 1 --nproc-per-node $1 scripts/finetune.py \
    --learning_rate 1e-4 \
