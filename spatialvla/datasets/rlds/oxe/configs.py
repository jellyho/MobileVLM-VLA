...
from spatialvla.datasets.rlds.oxe.utils.droid_utils import zero_action_filter
...
OXE_DATASET_CONFIGS = {
    ...
    "lg_upright_cup_joint": { #NOTE dataset config for onearm sim
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["joint_pos"],
        "state_encoding": StateEncoding.POS_EULER,
    ...
    "lg_upright_cup_ee": { #NOTE dataset config for onearm sim
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["joint_pos"],
        "state_encoding": StateEncoding.POS_EULER,
    ...
    "lg_upright_cup": { #NOTE dataset config for onearm sim
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["joint_pos"],
        "state_encoding": StateEncoding.POS_EULER,
    ...
    "lg_stack_bowls_5hz": { #NOTE dataset config for bimanual real robot clean
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
    ...
    "lg_clean": { #NOTE dataset config for bimanual real robot clean
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["ee_pos"],
        "state_encoding": StateEncoding.JOINT_BIMANUAL,
    ...
    "bm_sim_abs": { #NOTE dataset config for bimanual sim
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["joint_pos"],
        "state_encoding": StateEncoding.JOINT_BIMANUAL,
    ...
    "bm_sim_v0_abs": { #NOTE dataset config for bimanual sim
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["joint_pos"],
        "state_encoding": StateEncoding.JOINT_BIMANUAL,
    ...
    "bm_sim_v0_vel": { #NOTE dataset config for bimanual sim
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["joint_pos"],
        "state_encoding": StateEncoding.JOINT_BIMANUAL,
