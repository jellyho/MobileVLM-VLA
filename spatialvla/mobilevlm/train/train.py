...
def find_all_linear_names(model):
    ...
    # multimodal_keywords = ['mm_projector', 'vision_tower', 'vision_resampler', 'action_head']
    ...
    ## HARD CODED
    return ['o_proj', 'down_proj', 'up_proj', 'q_proj', 'gate_proj', 'k_proj', 'v_proj']
...
def find_all_non_lora_train_names(model):
    cls = torch.nn.Linear
    lora_module_names = set()
    multimodal_keywords = ['mm_projector', 'action_head']
