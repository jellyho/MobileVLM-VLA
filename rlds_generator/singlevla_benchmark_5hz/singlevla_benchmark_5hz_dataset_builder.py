...
class SinglevlaBenchmark5hz(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        """Define data splits."""
        return {
            'train': self._generate_examples(path='/home/shared/singlevla_benchmark/*/*.hdf5'),
        }
    ...
    def _generate_examples(self, path) -> Iterator[Tuple[str, Any]]:
        ...
        def _parse_example(hdf5_path):
            ...
            image = root['/observation/rightview_image']
